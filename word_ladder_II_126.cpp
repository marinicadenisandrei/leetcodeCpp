/* Leetcode - 126. Word Ladder II (C++ language) - Hard */
...
vector<vector<string>> findLadders(string beginWordVar, string endWordVar, vector<string> wordListVar);
...
int main()
{
    ...
    cout << "Leetcode - 126. Word Ladder II (C++ language) - ";
    ...
    for (int test = 0; test < beginWord.size(); test++)
    {
        ...
        vector<vector<string>> output = findLadders(beginWord[test], endWord[test], wordList[test]);
